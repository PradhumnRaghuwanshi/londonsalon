        ...
        <div style={{width:'75%', backgroundColor:'white', margin:25, display:'flex', flexDirection:'row'}}>
          ...
          <div style={{display:'flex', flexDirection:'row', marginLeft:10}}>
            <div style={{backgroundColor:'#A92A55', height:'20vh', width:'22%', borderRadius:10, border:'1px solid #A92A55'}}>
                <img style={{height:'20vh', width:'100%', borderRadius:10}} src='https://cdn.yesmadam.com/images/live/category/hair-salon-dncr-category-24-11-22.jpg'></img>
            </div>
          ...
          <div style={{display:'flex',flexDirection:'column', height:'60vh', justifyContent:'space-evenly', padding:15}}>
            ...
            <div style={{display:'flex', flexWrap:'wrap', width:'100%', height:'40vh'}}>
                <div style={{display:'flex',width:'20%', flexDirection:'column', justifyContent:'space-between', alignItems:'center', height:'18vh'}}>
                    <img style={{borderRadius:'50%', width:'75%'}} src='https://cdn.yesmadam.com/images/live/app/mainsubcategory/1625048771086.jpg'></img>
                    <label>Haircut Service</label>
                </div>
                <div style={{display:'flex',width:'20%', flexDirection:'column', justifyContent:'space-between', alignItems:'center', height:'18vh'}}>
                    <img style={{borderRadius:'50%', width:'75%'}} src='https://cdn.yesmadam.com/images/live/app/mainsubcategory/1626770515868.jpg'></img>
                    <label>Keratin Hair Spa</label>
                </div>
                <div style={{display:'flex',width:'20%', flexDirection:'column', justifyContent:'space-between', alignItems:'center', height:'18vh'}}>
                    <img style={{borderRadius:'50%', width:'75%'}} src='https://cdn.yesmadam.com/images/live/app/mainsubcategory/1626770447136.jpg'></img>
                    <label>Hair Care Service</label>
                </div>
